...
<!-- user input -->
<form action="Form3Designer.php" method="post">
Search <input type="text" name="search"><br>

Column: <select name="column">
    <option value="d_id">Designer ID</option>
	<option value="d_loc">Location</option>
...
$sql = "select * from designerComp where $column like '%$search%'";
...
while($row = $result->fetch_assoc() ){
    ...
    echo '<b>'."Designer ID: ".$row["d_id"].'<br />';
    echo "Location: ".$row["d_loc"].'<br />';
