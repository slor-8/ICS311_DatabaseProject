...
while ($row = mysqli_fetch_array($res_data)){
    ...
    $field2name = $row["cat_style"];
    $field3name = $row["cat_color"];
    $field4name = $row["cat_sew_technique"];
    $field5name = $row["cat_set"];
    $field6name = $row["cat_size"];

    echo '<b>'."Category ID: ".$field1name.'<br />';
    echo "Style: ".$field2name.'<br />';
    echo "Color: ".$field3name.'<br />';
    echo "Sewing Technique: ".$field4name.'<br />';
    echo "In A Set: ".$field5name.'<br />';
    echo "size: ".$field6name.'<br />';
    echo '</b>';
}
mysqli_close($conn);
?>
