...
<h3> Seller Join Product Table </h3>
...
$total_pages_sql = "SELECT COUNT(*) FROM seller natural join product";
$result = mysqli_query($conn,$total_pages_sql);
$total_rows = mysqli_fetch_array($result)[0];
$total_pages = ceil($total_rows / $no_of_records_per_page);

$sql = "SELECT * FROM seller natural join product LIMIT $offset, $no_of_records_per_page";
...
while ($row = mysqli_fetch_array($res_data)){
    ...
    echo "Designer ID: ".$field8name.'<br />';
