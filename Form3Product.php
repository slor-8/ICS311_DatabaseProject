...
<!-- user input -->
<form action="Form3Product.php" method="post">
...
$sql = "select * from product where $column like '%$search%'";
...
while($row = $result->fetch_assoc() ){
    ...
    echo '<b>'."Product Code: ".$row["prod_code"].'<br />';
    echo "Price: ".$row["prod_price"].'<br />';
    echo "Type: ".$row["prod_type"].'<br />';
